      ...
      >
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            Your account has been created successfully. You're now ready to start growing your productivity garden!
          </p>
        </div>
  ...
  return (
    ...
    >
      <div className="text-center mb-6">
        ...
        <p className="text-gray-600">
          Create your account and start growing your productivity
        </p>
      </div>
